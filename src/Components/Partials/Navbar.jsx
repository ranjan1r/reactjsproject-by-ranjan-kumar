                    ...
                    <div className="row gx-0 align-items-center">
                        <div className="col-lg-8 text-center text-lg-start mb-lg-0">
                            <div className="d-flex flex-wrap">
                                ...
                                <div className="ps-3">
                                    <Link to="vivek@123gmail.com" target="_blank" rel="noopener noreferrer" className="text-muted small"><i className="fas fa-envelope text-primary me-2"></i>vivek@123gmail.com</Link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="collapse navbar-collapse" id="navbarCollapse">
                            <div className="navbar-nav mx-0 mx-lg-auto">
                                ...
                                <div className="nav-btn px-6">
                                    ...
                                    <a href="#" className="btn btn-primary rounded-pill py-2 px-8 ms-2 flex-shrink-0"> Get a Quote</a>
                                </div>
                            </div>
                        </div>
                        <div className="d-none d-xl-flex flex-shrink-0 ps-4">
                            <Link to="tel:7903201546" target="_blank" rel="noreferrer" className="btn btn-light btn-lg-square rounded-circle position-relative wow tada" data-wow-delay=".9s">
                                ...
                                <div className="navbar-nav mx-0 mx-lg-auto">
                                    ...
                                    <div className="nav-item dropdown">
                                        <Link to="/" className="nav-link" data-bs-toggle="dropdown">
                                            <span className="dropdown-toggle">Gauri Singh</span>
                                        </Link>
